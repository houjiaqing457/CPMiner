...
**Note:** Below, we only show commands for ASTRAL-3. By replacing `java -jar astral.5.7.8.jar` with `  java -Djava.library.path=./lib/ -jar __astralmp.jar__` you can switch to ASTRAL-MP.
